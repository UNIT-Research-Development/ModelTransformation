...
/**
 * This is the item provider adapter for a {@link list.Element} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ElementItemProvider extends NamedElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addElementFeaturePropertyDescriptor(object);
		}
	 ...
	 * @generated
	 */
	protected void addElementFeaturePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_ElementFeature_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_ElementFeature_feature", "_UI_Element_type"),
				 ListPackage.Literals.ELEMENT__ELEMENT_FEATURE,
				 true,
				 false,
				 true,
				 null,
