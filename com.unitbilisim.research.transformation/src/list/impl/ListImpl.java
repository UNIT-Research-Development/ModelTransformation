 ...
 * <ul>
 *   <li>{@link list.impl.ListImpl#getOwnedElements <em>Owned Elements</em>}</li>
 *   <li>{@link list.impl.ListImpl#getListFeatures <em>List Features</em>}</li>
 *   <li>{@link list.impl.ListImpl#getSize <em>Size</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ListImpl extends NamedElementImpl implements List {
	...
	protected EClass eStaticClass() {
		return ListPackage.Literals.LÝST;
	}
	...
	public EList<Element> getOwnedElements() {
		if (ownedElements == null) {
			ownedElements = new EObjectContainmentEList<Element>(Element.class, this, ListPackage.LÝST__OWNED_ELEMENTS);
		}
	...
	public EList<Feature> getListFeatures() {
		if (listFeatures == null) {
			listFeatures = new EObjectResolvingEList<Feature>(Feature.class, this, ListPackage.LÝST__LÝST_FEATURES);
		}
		return listFeatures;
	}
	...
	public void setSize(int newSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ListPackage.LÝST__SÝZE, oldSize, size));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ListPackage.LÝST__LÝST_FEATURES:
