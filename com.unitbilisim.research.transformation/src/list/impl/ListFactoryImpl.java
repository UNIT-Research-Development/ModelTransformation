...
public class ListFactoryImpl extends EFactoryImpl implements ListFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ListPackage.LÝST: return createList();
			case ListPackage.ELEMENT: return createElement();
			case ListPackage.NAMED_ELEMENT: return createNamedElement();
			case ListPackage.UNÝQUE_ELEMENT: return createUniqueElement();
			case ListPackage.FEATURE: return createFeature();
			case ListPackage.COLLECTÝON: return createCollection();
			default:
