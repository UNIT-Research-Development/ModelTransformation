 ...
 * <ul>
 *   <li>{@link list.impl.ElementImpl#getElementFeature <em>Element Feature</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ElementImpl extends NamedElementImpl implements Element {
	...
	protected EClass eStaticClass() {
		return ListPackage.Literals.ELEMENT;
	}
		...
		if (elementFeature != null && elementFeature.eIsProxy()) {
			...
			if (elementFeature != oldElementFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ListPackage.ELEMENT__ELEMENT_FEATURE, oldElementFeature, elementFeature));
			}
		}
	...
	public void setElementFeature(Feature newElementFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ListPackage.ELEMENT__ELEMENT_FEATURE, oldElementFeature, elementFeature));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ListPackage.ELEMENT__ELEMENT_FEATURE:
