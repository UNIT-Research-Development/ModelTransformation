...
public class ListSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ListPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ListPackage.UNÝQUE_ELEMENT: {
				UniqueElement uniqueElement = (UniqueElement)theEObject;
				T result = caseUniqueElement(uniqueElement);
				if (result == null) result = caseElement(uniqueElement);
				if (result == null) result = caseNamedElement(uniqueElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ListPackage.FEATURE: {
